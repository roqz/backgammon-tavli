...
import { GamerulesPortes } from "./gamerules-portes";
describe("GamerulesPortes", () => {
    let rules: GamerulesPortes;
    ...
    beforeEach((() => {
        ...
        rules = new GamerulesPortes(board, p1, p2, diceService, store);
    ...
    it("should return Gameresult if game is over", (() => {
        ...
        rules = new GamerulesPortes(new Board(), p1, p2, diceService, store);
    ...
    it("should not be possible to double because this variant does not support it", (() => {
        rules["_currentPlayer"] = p1;
