...
import { GamerulesPlakato } from "./gamerules-plakato";
describe("GamerulesPlakato", () => {
    let rules: GamerulesPlakato;
    ...
    beforeEach((() => {
        ...
        rules = new GamerulesPlakato(board, p1, p2, diceService, store);
